...
// Global resend notifications.
$string['globalresend'] = 'Global notification resend';
$string['globalresenddesc'] = 'Manual institutional reactivation engine to resend consolidated reminders to teachers and students.';
$string['globalresendheading'] = 'Institutional resend execution';
$string['choosecourse'] = 'Course';
$string['choosecourse_desc'] = 'You may resend for all courses or limit the action to a single course.';
$string['recipient'] = 'Recipients';
$string['recipient_desc'] = 'Select the recipients for the resend.';
$string['recipients_students'] = 'Students';
$string['recipients_teachers'] = 'Teachers';
$string['recipients_both'] = 'Teachers and students';
$string['content'] = 'Content to resend';
$string['content_pending'] = 'Pending work';
$string['content_progress'] = 'Progress';
$string['content_followup'] = 'Follow-up';
$string['content_risk'] = 'Risk';
$string['resend'] = 'Resend notifications';
$string['globalresenddone'] = '{$a} notifications resent.';
$string['resend_message_subject'] = 'Reminder for course {$a}';
$string['resend_message_small'] = 'You have a new reminder.';
$string['resend_message_greeting'] = 'Hello {$a}, here is an update about your course activity:';
$string['resend_message_pending_student'] = '{$a} pending case(s) require your attention.';
$string['resend_message_pending_teacher'] = '{$a} pending case(s) need your review.';
$string['resend_message_progress'] = 'Progress: {$a->done}/{$a->total} completed, {$a->pending} pending.';
$string['resend_message_followup'] = 'Latest follow-up status: {$a}.';
$string['resend_message_risk'] = 'Current risk level: {$a}.';
$string['resend_message_signature'] = 'This is an automated reminder from VNotificator.';
...
$string['totalstudents'] = 'Unique monitored students';
$string['activestudents'] = 'Currently not at risk';
$string['studentsatrisk'] = 'En riesgo';
$string['highriskstudents'] = 'Riesgo alto';
$string['recoveredstudents'] = 'Recuperados';
$string['openalerts'] = 'Open cases';
$string['coveragepercent'] = 'Human follow-up coverage';
...
$string['criticalcasesreport'] = 'Prioritised critical records';
$string['studentcourseobservations'] = 'Student-course records';
$string['unassignedtutor'] = 'No tutor assigned';
$string['unassignedcohort'] = 'No cohort assigned';
$string['criticalrecordsnote'] = '{$a->records} prioritised records corresponding to {$a->students} unique students. The institutional total of high-risk students is {$a->total}.';
$string['reportunitnote'] = 'Institutional unit: unique students. Course summaries also show student-course records.';
$string['applyandrecalculate'] = 'Apply and recalculate';
$string['riskprofiletitle'] = 'Risk profile by category';
$string['riskprofilesubtitle'] = 'Categorical comparison for the selected period; this is not a time series.';
$string['riskprofilemeaning'] = 'Institutional risk profile: higher priority and critical values indicate greater intervention urgency.';
$string['identifiedreportrestricted'] = 'Identified exports require specific institutional authorisation.';
$string['exportcriticalanoncsv'] = 'Export pseudonymised critical cases';
$string['pceinotifications:viewidentifiedreports'] = 'View and export identified institutional reports';
$string['analyticsrecalculationrequired'] = 'The visible data was calculated by an earlier analytics version. Run the V9.4.2 recalculation before using it.';
...
// Privacy metadata added in V9.4.1.
$string['privacy:metadata:log'] = 'Notification delivery and processing records.';
$string['privacy:metadata:risk'] = 'Temporary academic risk indicators calculated from Moodle activity.';
$string['privacy:metadata:followup'] = 'Human-reviewed pedagogical follow-up records.';
$string['privacy:metadata:novelty'] = 'Academic follow-up cases and their human validation.';
$string['privacy:metadata:subject'] = 'Notification subject.';
$string['privacy:metadata:tutorid'] = 'Identifier of the assigned tutor.';
$string['privacy:metadata:teacherid'] = 'Identifier of the teacher who recorded the follow-up.';
$string['privacy:metadata:lastactivity'] = 'Time of the most recent activity used in the calculation.';
$string['privacy:metadata:inactivitydays'] = 'Calculated number of days without activity.';
$string['privacy:metadata:risklevel'] = 'Temporary risk category generated by configurable rules.';
$string['privacy:metadata:followupstatus'] = 'Current human-reviewed follow-up status.';
$string['privacy:metadata:timecalculated'] = 'Time at which the indicator was calculated.';
$string['privacy:metadata:contacttype'] = 'Type of follow-up contact.';
$string['privacy:metadata:note'] = 'Follow-up note.';
$string['privacy:metadata:commitment'] = 'Commitment registered during follow-up.';
$string['privacy:metadata:evidence'] = 'Evidence registered during follow-up.';
$string['privacy:metadata:noveltytitle'] = 'Title of the academic follow-up case.';
$string['privacy:metadata:noveltydetail'] = 'Detail of the academic follow-up case.';
$string['privacy:metadata:studentresponse'] = 'Student response recorded for the case.';
$string['privacy:metadata:teachervalidation'] = 'Teacher validation recorded for the case.';
